...
//        dump(M()->getLastSql());die;
        ...
        if (check_arr($rs)) {
            ...
            $content = '尊敬的T-Bees用户您好,<br/>您有一笔买入 '.$num.' '.$adverData['coin_type'].' 的订单 '.$order_id.' 尚未支付，请尽快完成支付并在网页点击“付款已完成”，否则订单将在30分钟后因超时被取消。如果您已经完成了支付，请在订单页面点击“付款已完成”，否则将无法收到对方支付的数字资产。';
